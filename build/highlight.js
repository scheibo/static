...
highlight_js_1.default.configure({ classPrefix: 'hl-' });
highlight_js_1.default.registerLanguage('Zig', () => ({
    name: 'Zig',
    aliases: ['zig'],
...
function highlight(source, language) {
    if (!language)
        return source;
    if (language !== 'console')
        return highlight_js_1.default.highlight(source, { language }).value;
    let cont = false;
